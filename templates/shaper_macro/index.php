...
//Custom Font 2
if ($this->params->get('enable_custom_font_2') && $this->params->get('custom_font_2_selectors')) {
    $webfonts[$this->params->get('custom_font_2_selectors')] = $this->params->get('custom_font_2');
}
    ...
    <head>
		...
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css">
            ...
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <?php
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css,fonts.css,custom.css,custom-responsive.css') // CSS Files
                        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, smoothscroll.js, jquery.mmenu.min.all.js, owl.carousel.min.js') // JS Files
