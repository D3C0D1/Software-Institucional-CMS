...
<div class="sp-comingsoon-wrap">	
	<div class="container">
		<div class="text-center">
			<div class="col-md-10 col-md-offset-1 col-sm-12" id="sp-comingsoon">
				...
				<?php if($this->countModules('comingsoon') || $this->params->get('comingsoon_content')) { ?>
				<div class="sp-position-comingsoon col-sm-offset-1 col-sm-10">
