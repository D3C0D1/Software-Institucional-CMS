...
$logo_exist = JFile::exists(JPATH_ROOT . '/templates/' . $this->template . '/images/error-logo.png');

if($logo_exist) {
    $error_logo = $this->baseurl . '/templates/' . $this->template . '/images/error-logo.png';
} else {
	...
	<body>
		<div class="container error-page-inner">
			<div class="row">
				...
				<div class="copyright">
					<p><?php echo $params->get('copyright'); ?></p>
				</div>
		</div>
	</body>
</html>