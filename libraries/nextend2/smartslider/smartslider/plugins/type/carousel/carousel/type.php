...
class N2SmartSliderTypeCarousel extends N2SmartSliderType {
    ...
    public function getScript() {
        if ($this->slider->params->get('single-switch', 0)) {
            return N2Html::script("N2R(" . json_encode($this->jsDependency) . ",function(){new N2Classes.SmartSliderCarouselSingle('#{$this->slider->elementId}', " . json_encode($this->javaScriptProperties) . ");});");
        } else {
            return N2Html::script("N2R(" . json_encode($this->jsDependency) . ",function(){new N2Classes.SmartSliderCarousel('#{$this->slider->elementId}', " . json_encode($this->javaScriptProperties) . ");});");
        }
    }
}