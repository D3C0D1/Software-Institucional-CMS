...
class N2SmartSliderTypeAccordion extends N2SmartSliderType {
    ...
    public function getScript() {
        return N2Html::script("N2R(" . json_encode($this->jsDependency) . ",function(){new N2Classes.SmartSliderAccordion('#{$this->slider->elementId}', " . json_encode($this->javaScriptProperties) . ");});");
    }
