...
class N2SSPluginResponsiveFullPage extends N2SSPluginSliderResponsive {
    ...
    public function renderFields($form) {
        ...
        new N2ElementOnOff($settings, 'responsiveConstrainRatio', n2_('Constrain ratio'), 1, array(
    ...
    public function parse($params, $responsive, $features) {
        ...
        $responsive->constrainRatio                 = intval($params->get('responsiveConstrainRatio', 1));
