...
class SppagebuilderAddonCall_to_action extends SppagebuilderAddons {
    ...
    public static function getTemplate() {
		...
		<div class="sppb-addon sppb-addon-cta {{contentClass}}" style="padding: 40px 20px;">
                <# if(button_position=="right") { #>
			<div class="sppb-row">
			...
			<# if (!_.isEmpty(subtitle)){ #>
                        <p class="sppb-lead sppb-cta-subtitle" style="font-size: {{subtitleFontSize}}px;"> {{{subtitle}}}</p>
                        <# } #>
                        <# if (!_.isEmpty(text)){ #>
